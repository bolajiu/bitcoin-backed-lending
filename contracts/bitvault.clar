;; Title: BitVault - Secure Bitcoin-backed Lending Protocol
;;
;; Summary: A decentralized lending protocol enabling Bitcoin holders to leverage their assets
;; while maintaining self-custody principles. BitVault allows users to deposit sBTC as collateral,
;; borrow against it, and participate in liquidations to maintain system solvency.
;;
;; Built for Stacks Layer 2, BitVault brings DeFi functionality to Bitcoin with proper 
;; risk management, transparent governance, and Bitcoin-compliant security standards.
...
(define-public (deposit-collateral
  ...
  (let (
    ...
    (match (contract-call? token-contract transfer amount sender (as-contract tx-sender)
      none
    )
      success (begin
